...
namespace Kmmp.Core.MqFramework.RocketMQ.Consumers
{
    ...
    public class OrderConsumerClient : ConsumerClientBase
    {
        ...
        public OrderConsumerClient(string accessKeyId, string accessKeySecret, string nameSrvAddr, string topic, string groupId, string subExpression = "*", int consumerThreadCount = 5)
        ...
        /// 启动
        /// </summary>
        /// <exception cref="NotFoundMessageListenerException"></exception>
