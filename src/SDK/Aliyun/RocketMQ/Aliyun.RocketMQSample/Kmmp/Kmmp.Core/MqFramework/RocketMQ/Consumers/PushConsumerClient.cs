...
namespace Kmmp.Core.MqFramework.RocketMQ.Consumers
{
    ...
    public class PushConsumerClient : ConsumerClientBase
    {
        ...
        public PushConsumerClient(string accessKeyId, string accessKeySecret, string nameSrvAddr, string topic, string groupId, string logPath = null, string subExpression = "*", int consumerThreadCount = 5)
